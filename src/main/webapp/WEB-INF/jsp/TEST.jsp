                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                        ...
                                        <td>${list.gender}</td>
                                        <td>${list.phoneNo}</td>
                                        <td><a href="/edit/${list.lectureId}"><i class="fa  fa-pencil"></i></a> </td>
                                        <%--<td><a href="#myModal"><i class="fa  fa-trash-o" data-toggle="modal" data-target="#modal"></i></a>--%>
                                        ...
                                        <%--</div>--%>
                                        <%--</td>--%>
                                     <td><a href="/delete/${list.lectureId}"><i class="fa  fa-trash-o"></i></a> </td>
                                  </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
