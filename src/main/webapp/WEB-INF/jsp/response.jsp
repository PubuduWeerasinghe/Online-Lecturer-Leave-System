                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/savv" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" class="form-control" placeholder="Enter Lecture ID" name="Id">
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" class="form-control" name="applyDate" value="${list.idd}">
                                    </div>
                                </div>
                            ...
                            <p class="card-text">
                                <div class="author">
                                    ...
                                    <a href="javascript:void(0)">
                                        <img class="avatar" src="/indexx/img/lecturerPhotoes/${list.lecture.imgSrc}" alt="...">
                                        <h5 class="title">${list.lecture.lectureName}</h5>
                                    </a>
                            <p class="description">
                                ${list.lecture.designation}
                            </p>
