...
<head>
    ...
    <link rel="stylesheet" href="/Template/assets/scss/widgets.css">
    ...
    <aside class="profile-nav alt">
        <section class="card">
            <div class="card-header user-header alt bg-dark">
                <div class="media">
                    <a href="#">
                        <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="/Template/images/admin.jpg">
                    </a>
                    <div class="media-body">
                        <h2 class="text-light display-6">${lists.lectureName}</h2>
                        <p>${lists.designation}</p>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="mx-auto d-block">
                <img class="rounded-circle mx-auto d-block" src="/Template/images/admin.jpg" alt="Card image cap">
